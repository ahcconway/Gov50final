...
visualization <- work |> 
  ...
  labs(y = "Unemployment as Proportion / 100", 
       title = "Sweden vs Denmark Unemployed Youth Immigrant Pop.") + 
...
Specificaly the immigrants are "foreign born with two foreign born parents"
```{r}
 work |>
